...
import { FormDeProductoComponent } from './form-de-producto/form-de-producto.component';
...
@Component({
  ...
  imports: [CommonModule, FormDeProductoComponent, ListaDeComprasComponent]
})
export class AdminComponent {
  view: 'productos' | 'compras' = 'productos';
